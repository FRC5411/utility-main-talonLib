 ...
 */
public class AngledElevatorFeedForward {
    ...
    /**
     * Creates a new AngledElevatorFeedForward with the specified gains. Units of the gain values will
     ...
     */
    public AngledElevatorFeedForward(double ks, double kg, double kv, double ka) {
      this.ks = ks;
      this.kg = kg;
      this.kv = kv;
      this.ka = ka;
    ...
    /**
     * Creates a new AngledElevatorFeedForward with the specified gains. Acceleration gain is defaulted to
     ...
     */
    public double calculate(double velocity, double acceleration, double thetaRadians) {
      return ks * Math.signum(velocity) + kg * Math.sin(thetaRadians) + kv * velocity + ka * acceleration;
    }
     ...
     * @return The computed feedforward.
     */
    public double calculate(double velocity, double thetaRadians) {
      return calculate(velocity, 0, thetaRadians);
    }
