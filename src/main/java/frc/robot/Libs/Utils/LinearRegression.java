...
public class LinearRegression {
   ...
   /**
     * Performs a linear regression on the data points (y[i], x[i]).
     ...
     This will throw an IllegalArgumentException if the lengths of the two arrays are not equal
     */
   ...
   /*
     Returns the y-intercept of the best of the best-fit line y = α + β x.
    */
    public double intercept() {
        return intercept;
    }
   /*
     Returns the slope β of the best of the best-fit line dy = α + β dx.
     */
    public double slope() {
        return slope;
    }
