 ...
 */
public class ProfilePIDController implements Sendable {
  private static int instances;

  private PIDController m_controller;
  private double m_minimumInput;
  private double m_maximumInput;
  private TProfile.State m_goal = new TProfile.State();
  private TProfile.State m_setpoint = new TProfile.State();
  private TProfile.Constraints m_constraints;
   ...
   */
  public ProfilePIDController(
      double Kp, double Ki, double Kd, TProfile.Constraints constraints) {
   ...
   */
  public ProfilePIDController(
      double Kp, double Ki, double Kd, TProfile.Constraints constraints, double period) {
  ...
  /**
   * Sets the goal for the ProfilePIDController.
   *
   * @param goal The desired goal state.
   */
  public void setGoal(TProfile.State goal) {
    m_goal = goal;
  }
  ...
  public void setGoal(double goal) {
    m_goal = new TProfile.State(goal, 0, 0);
  }

  /**
   * Gets the goal for the ProfilePIDController.
   *
   * @return The goal.
   */
  public TProfile.State getGoal() {
    return m_goal;
  }
   ...
   * @param constraints Velocity and acceleration constraints for goal.
   */
  public void setConstraints(TProfile.Constraints constraints) {
    m_constraints = constraints;
  }

  /**
   * Returns the current setpoint of the ProfilePIDController.
   *
   * @return The current setpoint.
   */
  public TProfile.State getSetpoint() {
    return m_setpoint;
  }
  ...
  public double calculate(double measurement) {
    ...
    var profile = new TProfile(m_constraints, m_goal, m_setpoint);
   ...
   * @return The controller's next output.
   */
  public double calculate(double measurement, TProfile.State goal) {
    setGoal(goal);
  ...
  public double calculate(
      double measurement, TProfile.State goal, TProfile.Constraints constraints) {
   ...
   */
  public void reset(TProfile.State measurement) {
    m_controller.reset();
  ...
  public void reset(double measuredPosition, double measuredVelocity) {
    reset(new TProfile.State(measuredPosition, measuredVelocity, 0));
  }
  ...
  public void initSendable(SendableBuilder builder) {
    builder.setSmartDashboardType("ProfilePIDController");
