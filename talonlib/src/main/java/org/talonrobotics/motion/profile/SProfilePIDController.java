 ...
 */
public class SProfilePIDController implements Sendable {
   ...
   */
  public SProfilePIDController(
      double Kp, double Ki, double Kd, SProfile.Constraints constraints) {
   ...
   */
  public void setGoal(SProfile.State goal) {
    m_goal = goal;
  }
  ...
  public void setGoal(double goal) {
    m_goal = new SProfile.State(goal, 0, 0, 0);
  }
   ...
   * @param constraints Velocity and acceleration constraints for goal.
   */
  public void setConstraints(SProfile.Constraints constraints) {
    m_constraints = constraints;
  }
   ...
   */
  public SProfile.State getSetpoint() {
    return m_setpoint;
  }
   ...
   * @return The controller's next output.
   */
  public double calculate(double measurement, SProfile.State goal) {
    setGoal(goal);
  ...
  public double calculate(
      double measurement, SProfile.State goal, SProfile.Constraints constraints) {
  ...
  public void reset(double measuredPosition, double measuredVelocity) {
    reset(new SProfile.State(measuredPosition, measuredVelocity, 0, 0));
  }
